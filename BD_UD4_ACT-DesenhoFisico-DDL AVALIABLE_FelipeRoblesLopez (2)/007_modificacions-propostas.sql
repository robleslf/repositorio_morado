-- Modificaciones propuestas a la Base de Datos NUESTRO_ZOOLOGICO.

-- Las modificaciones han de hacerse en este orden, o ejecutarse el script entero, porque estas tienen en cuenta modificaciones hechas en tablas anteriores, como cambios en nombres de atributos o tablas, haciendo referencia a los nuevos nombres.
